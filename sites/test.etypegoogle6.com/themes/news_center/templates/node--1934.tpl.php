...
{
   $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?IssueID=102656&ReturnUrl=http://www.etypeservices.com/Subscriber/ReSubscribe.aspx?PubID=3168'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
...
<body>
  ...
  <section class="container login1">
    <div class="login">
<h2>Login</h2>
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="/content/forgot-password" style="color:#000">Click here </a>.</p>
    </div>
  </section>
