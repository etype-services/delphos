    <?php
     ...
     $response=$client->GetSubsciptionPlan($param);
      ...
      ?>
       <form  name="planform" method="POST" action="/content/checkout" enctype="multipart/form-data">
<fieldset>
    <style>
...
<img src="http://www.fairburyjournalnews.com/sites/default/files/fairbury_news_logo.jpg"  style="width:95%; height:170px;">
...
<br/>
<strong>Already a print subscriber? <a href="/content/already-print-subscriber" style="color:red">Fill out this form</a> to activate your digital subscription. Once your print subscription is verified, your user account will be enabled.</strong>
             </p>
...
<strong><h3>Fairbury Journal News </h3></strong>
