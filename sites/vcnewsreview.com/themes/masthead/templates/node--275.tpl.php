   ...
   // echo "<pre>";
    ...
    //  echo "</pre>";
      ...
      ?>
       <form  name="planform" method="POST" action="/checkout" enctype="multipart/form-data">
<fieldset>
    <style>
/*
...
<div class="header1" >
<div class="headertop">
<h1 style="background: gray;margin-right: 1px;"> <center style="font-size: 22px !important;padding: 1%;">CHOOSE THE SUBSCRIPTION THAT'S RIGHT FOR YOU</center></h1></div>
<!--<div class="headerdown">
<div class="headerdl" style="height:200px;">


<img src="http://www.vcnewsreview.com/sites/default/files/vilas.jpg"  style="width:95%; height:150px;">

</div></div>
-->
          
<br/>
            <p style="text-align: justify;margin-right: 1px;margin-top: 13px;">
            <strong>Already a print subscriber? <a href="/already-print-subscriber" style="color:red">Fill out this form</a> to activate your digital subscription. Once your print subscription is verified, your user account will be enabled.</strong>
            <br/>
              Select the Subscription Plan that is right for you, then click Submit!. You will be taken to a form where you will be asked to submit your customer and billing info.
<br/>
...
<strong><h3>Vilas County News Review </h3></strong>
