<div id="page"><div class="page-inner <?php echo $grid_size ?>">
    ...
    <nav id="user-menu" class="clearfix">
      ...
      <div id="social">
        <ul class="social-links">
          <li><a class="rss" href="<?php print $base_path ?>rss.xml"><span class="sr-only">RSS</span></a></li>
          <li><a class="facebook" href="<?php echo $facebook ?>"><span class="sr-only">Facebook</span></a></li>
        </ul>
      </div>
    </nav>
  <?php endif; ?>
  ...
  <div class="header-wrapper clearfix"><div class="header-wrapper-inner <?php echo $grid_full_width ?>">
    <header>
      ...
      <?php if ($logo): ?>
        <div class="site-logo">
          <a href="<?php print check_url($front_page); ?>"><img src="<?php print $logo ?>" alt="<?php print $site_name; ?> Logo" /></a>
